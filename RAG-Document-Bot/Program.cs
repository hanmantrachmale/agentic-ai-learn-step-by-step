...
// =========================================================================
// This is the ONLY block in Program.cs that changes to use real .pdf/.docx
// documents instead of MockIncidentData. Everything else - the embedding
// generator setup, the vector store setup, RetrieveContextAsync, and the
// chat loop - stays EXACTLY as it was.
// =========================================================================

// STEP 0 (add near your other .env reads, alongside OLLAMA_* variables):

var documentsFolder = Environment.GetEnvironmentVariable("DOCUMENTS_FOLDER") ?? "./documents";

// -------------------------------------------------------------------
// MILESTONE 4 (part 2) - REPLACED to load real documents instead of mock data.
// -------------------------------------------------------------------
Console.WriteLine($"Loading and chunking documents from '{documentsFolder}'...");

var incidentData = DocumentIngestionSource.LoadAndChunkDocuments(documentsFolder, maxWordsPerChunk: 200, overlapWords: 40);

Console.WriteLine($"Ingesting {incidentData.Count} document chunks...");

foreach(var (id, text) in incidentData)
{
...
Console.WriteLine("=========================================");
Console.WriteLine(" RAG Document Bot (Ollama, local, free)");
Console.WriteLine("=========================================");
